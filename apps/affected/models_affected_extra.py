...
class AffectedExtraStatus(str, Enum):
    PENDING='pending'; ACTIVE='active'; FAILED='failed'

@dataclass
class AffectedExtraEntity:
    ...
    def affected_process_0(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        elif 3>1 and "individuals" == "needs":
